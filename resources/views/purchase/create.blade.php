        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add New Purchas Order</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <div class="form-body mt-4">
                ...
                <form action="{{ route('create_purchase.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="border border-3 p-4 rounded">
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="vend_id" class="form-label">Supplier</label> <span
                                ...
                                <div class="col-md-3">
                                    <label for="pur_date" class="form-label">Purchase Date</label> <span
                                        class="text-danger">*</span>
                                    <input type="date" name="pur_date" class="form-control date-input" id="pur_date"
                                ...
                                <div class="col-md-3">
                                    <label for="pur_status" class="form-label">Purchase Status</label> <span
                                        class="text-danger">*</span>
                                    {!! purchase_status_dropdown("" ,"pur_status" ,"pur_status") !!}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="file" name="pur_document[]" class="form-control" id="pur_document"
                                        placeholder="Purchase Document" multiple="multiple">
                                ...
                                <div class="mb-3 col-lg-12 mt-4">
                                    ...
                                    <textarea name="remarks" class="form-control" id="remarks" placeholder="Remarks"
                                        rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-condensed" id="myTable">
                                        ...
                                        <tr>
                                            <td>
                                                <select name="item_id[]" id="item_id" onchange="get_item_details(this)"
                                            ...
                                            <td>
                                                <input type="any" name="item_pur_price[]" class="form-control"
                                                    id="item_pur_price" placeholder="Purchase Price" required readonly>
                                            </td>
                                            <td>
                                                <input type="text" name="units_in_carton[]" class="form-control"
                                                    id="units_in_carton" placeholder="Units In Carton" required>
                                            </td>
                                            <td>
                                                <input type="text" name="pur_item_qty[]"
                                                    onkeyup="calculate_sub_total_carton(this)" class="form-control"
                                                    id="pur_item_qty" placeholder="Purchase Qty"
                                                    placeholder='Total Amount' required>
                                            </td>
                                            <td>
                                                <input type="any" name="carton_qty[]" class="form-control"
                                                    id="carton_qty" placeholder="Carton Qty" required>
                                            </td>
                                            <td>
                                                <input type="any" name="sub_total_amount[]" class="form-control"
                                                    id="sub_total_amount" placeholder="Total Amount"
                                                    placeholder='Total Amount' required>
                                            </td>
                                            <td>
                    ...
                    <div class="mt-4 col-lg-8">
                        <div class="row mb-3">
                            <label for="alibaba_charges" class="col-sm-3 col-form-label">Alibaba Charges <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="any" name="alibaba_charges" class="form-control charges"
                                    id="alibaba_charges" placeholder="Alibaba Charges" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="any" name="shipping_charges" class="form-control charges"
                                    id="shipping_charges" placeholder="Shipping Charges" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="any" name="miscellaneous_charges" class="form-control charges"
                                    id="miscellaneous_charges" placeholder="Miscellaneous Charges" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="pur_total_amount" class="col-sm-3 col-form-label">Purchase Total Amount <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="any" name="pur_total_amount" class="form-control charges"
                                    id="pur_total_amount" placeholder="Purchase Total Amount" required>
                        ...
                        <div class="row mb-3">
                            <label for="pur_grand_total" class="col-sm-3 col-form-label">Purchase Grand Total <span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="any" name="pur_grand_total" class="form-control" id="pur_grand_total"
                                    placeholder="Purchase Grand Total" required>
...
function add_row() {
    ...
    cell2.innerHTML = cell2.innerHTML +
        ...
        "' placeholder='Purchase Price' required readonly>";
