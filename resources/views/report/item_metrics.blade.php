...
<div class="page-content">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">All Items Metrics</li>
                </ol>
            </nav>
        </div>
    ...
    <h6 class="mb-0 text-uppercase">Items Metrics</h6>
    <hr />
    <br>
    <div class="card">
        <div class="card-body">
            <div style="text-align:center;">
                ...
                <a class="toggle-vis btn btn-sm btn-primary" data-column="3">Total Purchase Price</a>
                <a class="toggle-vis btn btn-sm btn-primary" data-column="4">Total Investment</a>
            ...
            <div class="table-responsive">
                ...
                <table id="example" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @foreach($item_stats_inwarehosue as $item_stats)
                        ...
                        <tr class="active-row">
                            ...
                            <td>{{$item_stats->wh_title}}</td>
                            <td>{{$item_stats->total_purchase_price}}</td>
                            <td>{{$item_stats->total_investment}}</td>
                            <td>{{$item_stats->total_sale_price}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
