<div class="card border-top border-0 border-4 border-primary">
    <div class="card-body p-5">
        <div class="card-title d-flex align-items-center">
            ...
            <h5 class="mb-0 text-primary">Variation Update</h5>
        </div>
        <hr>
        <form action="{{ route('variant.update',$variant->var_id) }}" method="post">
            @csrf
            <div class="row">
                <div class="col-lg-6 mt-4">
                    <label for="var_color" class="form-label">Variation Color </label>
                    <input type="text" name="var_color" class="form-control" id="var_color"
                        value="{{$variant->var_color}}" placeholder="Enter Variation Color">
                ...
                <div class="col-lg-6 mt-4">
                    ...
                    <input type="text" name="var_size" class="form-control" id="var_size" value="{{$variant->var_size}}"
                ...
                <div class="col-lg-6 mt-4">
                    ...
                    <input type="text" name="var_material" class="form-control" id="var_material"
                        value="{{$variant->var_material}}" placeholder="Enter Variation Material">
                ...
                <div class="col-lg-6 mt-4">
                    ...
                    <input type="text" name="var_weight" class="form-control" id="var_weight"
                        value="{{$variant->var_weight}}" placeholder="Enter Variation Weight">
